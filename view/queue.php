...
<head>
  ...
  <?php
   ...
   $includes = ["./src/queue_functions.js", "./src/logout.js", "./src/notification.js"];
...
<body>
  ...
  <div class="jumbotron jumbotron-billboard padding-left-20 padding-right-20 flex flex-column flex-alignItems-center flex-noShrink">
