...
<body>
  ...
  <div class="container  padding-bottom-20">
    <div class="col-md-12">
      ...
      <p style="font-size: 17px">
        TA privileges are granted via course settings page on the queue. To be able to modify the settings for a course, a user must be a member of the admin group. This can be done by sending an email to opers@eng.utah.edu
      </p>
      ...
      <h3>Administrator</h3>
      <p style="font-size: 17px">
        If the user is an admin, they will be presented with a page that allows them to view and modify all courses. Additionally, they will see an admin dropdown menu in the navbar which allows them to create courses.
      </p>
